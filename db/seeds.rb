...
current_book = Book.create(title:"My Answer is No . . . If That's Okay with You: How Women Can Say No and (Still) Feel Good About It", isbn:"B0012D1CV0", author:"Nanette Gartrell",rating: 5)
